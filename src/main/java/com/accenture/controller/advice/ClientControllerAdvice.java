...
public class ClientControllerAdvice {
    ...
    @ExceptionHandler(ClientException.class)
    public ResponseEntity<ErrorDto> entityNotFoundsException(Exception e) {
    ...
    public ResponseEntity<ErrorsDto> handleValidationException(MethodArgumentNotValidException e) {
